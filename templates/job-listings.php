	...
	<div class="ajem-listings-container">
		...
		<div class="ajem-jobs-list">
			...
			<?php else : ?>
				...
				?>
				<div class="ajem-job-card<?php echo $job->is_featured ? ' ajem-job-card-featured' : ''; ?>">
					...
					<div class="ajem-job-card-header">
						...
						<?php if ( ! empty( $job->company_logo ) ) : ?>
							<img src="<?php echo esc_url( $job->company_logo ); ?>"
								...
								class="ajem-job-card-logo">
						<?php else : ?>
							<div class="ajem-job-card-logo-placeholder">
						...
						<div class="ajem-job-card-info">
							<h3 class="ajem-job-card-title">
								<a href="<?php echo $jt_url; ?>"><?php echo esc_html( $job->job_title ); ?></a>
							</h3>
							...
							<div class="ajem-job-card-meta">
								...
								<?php endif; ?>
								<?php if ( $jt_sal ) : ?>
									<span class="ajem-salary-chip">💰 <?php echo esc_html( $jt_sal ); ?></span>
								<?php endif; ?>
							</div>
						</div>

					</div><!-- /.ajem-job-card-header -->

					<div class="ajem-job-card-footer">
						<span class="ajem-job-date">
							<?php echo esc_html( human_time_diff( strtotime( $job->created_at ), time() ) . ' ' . __( 'ago', 'ai-job-employer-manager' ) ); ?>
						</span>
						<a href="<?php echo $jt_url; ?>" class="ajem-btn ajem-btn-sm ajem-btn-primary">
							<?php esc_html_e( 'View Job', 'ai-job-employer-manager' ); ?>
						</a>
					</div><!-- /.ajem-job-card-footer -->
